...
#ifdef CONFIG_ISDBT
/* Setup SSP1 device */
static uint8_t clk_name[4][32] = { "ssp0_clk", "ssp1_clk", "ssp3_clk", "ssp4_clk"};

#ifdef CONFIG_DMAC_PL330
static char dma_tx_chan_name[4][32] = {
	"SSP_0B_TX0",
	"SSP_1B_TX0",
	"SSP_2B_TX0",
	"SSP_2D_TX1"
...
static char dma_rx_chan_name[4][32] = {
	"SSP_0A_RX0",
	"SSP_1A_RX0",
	"SP_2A_RX0",
	"SSP_2C_RX1"
...
static unsigned int dma_fifo_base[4] = {
	SSP0_BASE_ADDR,
	SSP1_BASE_ADDR,	
	SSP3_BASE_ADDR,
	SSP4_BASE_ADDR
...
#endif
#else
static uint8_t clk_name[4][32] = { "ssp0_clk", "ssp4_clk", "ssp3_clk", "ssp1_clk" };
