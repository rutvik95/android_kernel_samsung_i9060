...
/************************/
	...
	const regs_t *af_return_macro_pos;
	 ...
	 const regs_t *focus_mode_normal_regs_default;	
	 const regs_t *focus_mode_macro_regs_default;
  ...
  int rows_num_focus_mode_normal_regs_default;
  int rows_num_focus_mode_macro_regs_default;
	/* flicker */
