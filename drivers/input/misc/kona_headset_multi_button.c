...
#define HEADPHONE_DETECT_LEVEL_MAX      910
...
static int __headset_hw_init_micbias_off(struct mic_t *p)
{
	...
	if (p->ldo) {
#if defined (CONFIG_MACH_HAWAII_SS_COMMON)  || defined(CONFIG_MACH_JAVA_SS_BAFFINLITE)|| defined(CONFIG_MACH_JAVA_SS_VICTOR3G)
