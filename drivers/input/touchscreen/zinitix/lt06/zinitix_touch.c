...
#if defined(CONFIG_MACH_HAWAII_SS_LT063G_REV00)
#include "zinitix_touch_zxt_firmware(020301).h"
#elif defined(CONFIG_MACH_HAWAII_SS_LT063G_REV01) || defined(CONFIG_MACH_HAWAII_SS_LT063G_REV02) || defined(CONFIG_MACH_HAWAII_SS_GOYA3G_REV02)
#include "zinitix_touch_zxt_firmware(020304).h"
#endif
...
static DEVICE_ATTR(touchkey_dummy_btn4, S_IRUGO,
					show_touchkey_sensitivity, NULL);
static DEVICE_ATTR(touchkey_dummy_btn5, S_IRUGO,
					show_touchkey_sensitivity, NULL);
...
#elif defined(CONFIG_MACH_HAWAII_SS_LT063G_REV01) || defined(CONFIG_MACH_HAWAII_SS_LT063G_REV02) || defined(CONFIG_MACH_HAWAII_SS_GOYA3G_REV02)
u32 BUTTON_MAPPING_KEY[MAX_SUPPORTED_BUTTON_NUM] = {
	KEY_DUMMY_MENU, KEY_MENU,
	KEY_BACK, KEY_DUMMY_BACK};
#endif
...
///////////////////////////////////////////////////////////////////////////////
	...
	if (tsp_regulator_3_3 == NULL){
		tsp_regulator_3_3 = regulator_get(NULL, "gpldo2_uc");
...
#elif defined(CONFIG_MACH_HAWAII_SS_LT063G_REV01) || defined(CONFIG_MACH_HAWAII_SS_LT063G_REV02) || defined(CONFIG_MACH_HAWAII_SS_GOYA3G_REV02)
		ret = regulator_set_voltage(tsp_regulator_3_3,2800000,2800000);
#endif
		...
		const struct i2c_device_id *i2c_id)
{
	...
	struct zinitix_touch_dev *touch_dev;
	int i;
	static unsigned int i2c_sda0_addr, i2c_scl0_addr;
...
//		IRQF_TRIGGER_LOW, ZINITIX_DRIVER_NAME, touch_dev);
	...
	if (device_create_file(sec_touchkey, &dev_attr_touchkey_back) < 0)
      ...
      if (device_create_file(sec_touchkey, &dev_attr_touchkey_dummy_btn5) < 0)
		pr_err("Failed to create device file(%s)!\n", dev_attr_touchkey_dummy_btn4.attr.name);
