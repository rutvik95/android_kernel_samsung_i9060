/*
 * mms136_ts.c - Touchscreen driver for Melfas MMS-series touch controllers
 *
...
/* 5.55" OCTA LCD */
#define FW_VERSION 0x11 /*Config Version*/
...
static void get_config_ver(void *device_data)
{
	...
	snprintf(buff, sizeof(buff), "I9060_ME_1007");
