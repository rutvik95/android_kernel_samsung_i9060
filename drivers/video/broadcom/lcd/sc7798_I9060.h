...
typedef enum {
    ...
    SC7798_CMD_FOSC					= 0xBF,//new cmnd for fosc
} SC7798_CMD_T;
...
__initdata DISPCTRL_REC_T sc7798_init_panel_vid[] = {
  ...
  {DISPCTRL_WR_CMND, SC7798_CMD_SETVDC},
	...
	{DISPCTRL_WR_DATA, 0x00},	
	{DISPCTRL_WR_DATA, 0x00},
	{DISPCTRL_WR_DATA, 0x41}, //81
	{DISPCTRL_WR_DATA, 0x40}, //80
	...
	{DISPCTRL_WR_CMND, SC7798_CMD_FOSC}, //new cmnd for fosc
	{DISPCTRL_WR_DATA, 0x0A},
