...
typedef enum {
	...
	HX8369_CMD_WRITE_BRIGHTNESS		= 0x51,
...
__initdata DISPCTRL_REC_T hx8369_init_panel_vid[] = 
{
	...
	{DISPCTRL_WR_DATA, 0x00},
	{DISPCTRL_WR_DATA, 0x00},
	{DISPCTRL_WR_DATA, 0x0D}, //0x0C
	{DISPCTRL_WR_DATA, 0x44},
	{DISPCTRL_WR_DATA, 0x39},
	
	{DISPCTRL_WR_DATA, 0x37}, //0x47
	...
	{DISPCTRL_WR_CMND, HX8369_CMD_SLEEP_OUT},
	{DISPCTRL_SLEEP_MS, 180},

	{DISPCTRL_WR_CMND, HX8369_CMD_DISP_ON},
	/*{DISPCTRL_SLEEP_MS, 100},*/
	{DISPCTRL_SLEEP_MS, 10},

	{DISPCTRL_WR_CMND, HX8369_CMD_SETCABC}, /*CABC setting*/
	{DISPCTRL_WR_DATA, 0x0F},
	{DISPCTRL_WR_DATA, 0x00},	 //0x00

	{DISPCTRL_WR_CMND, HX8369_CMD_WRITE_BRIGHTNESS}, //Write display brightness value
	{DISPCTRL_WR_DATA, 0xFF}, // dute cycle

	{DISPCTRL_WR_CMND, HX8369_CMD_BL}, /*Write Control Display*/
	{DISPCTRL_WR_DATA, 0x24},

	{DISPCTRL_LIST_END, 0},
};

__initdata DISPCTRL_REC_T hx8369_init_panel_vid_low_temp[] = {
  	{DISPCTRL_WR_CMND, HX8369_CMD_ENABLE_CMD},
	{DISPCTRL_WR_DATA, 0xFF},		
	{DISPCTRL_WR_DATA, 0x83},
	{DISPCTRL_WR_DATA, 0x69},
...
__initdata struct lcd_config hx8369_cfg = {
	...
	.init_vid_lowtemp_seq = &hx8369_init_panel_vid_low_temp[0],
#endif	
