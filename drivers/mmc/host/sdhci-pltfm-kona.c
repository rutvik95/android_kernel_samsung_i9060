...
static int __devinit sdhci_pltfm_probe(struct platform_device *pdev)
{
	...
	***/
	...
	/***
		NANI
		To check Pin - Pad setting.
	***/
	if( !strcmp( mmc_hostname(host->mmc), "mmc0" ) ) {
		// PAD_CTRL (0x35004800)
		// PAD_CTRL_MMC0CK (0x3500490C)
		// PAD_CTRL_MMC0CMD (0x35004910)
		// PAD_CTRL_MMC0DAT0 (0x35004914)
		// PAD_CTRL_MMC0DAT1 (0x35004918)
		// PAD_CTRL_MMC0DAT2 (0x3500491C)
		// PAD_CTRL_MMC0DAT3 (0x35004920)
		// PAD_CTRL_MMC0DAT4 (0x35004924)
		// PAD_CTRL_MMC0DAT5 (0x35004928)
		// PAD_CTRL_MMC0DAT6 (0x3500492C)
		// PAD_CTRL_MMC0DAT7 (0x35004930)
		printk( "[NANI] %s, %d : PAD_CTRL_MMC0CK == %#x\n", __FUNCTION__, __LINE__, readl( IO_PHYS_TO_VIRT(0x3500490C) ) );
		printk( "[NANI] %s, %d : PAD_CTRL_MMC0CMD == %#x\n", __FUNCTION__, __LINE__, readl( IO_PHYS_TO_VIRT(0x35004910) ) );
		printk( "[NANI] %s, %d : PAD_CTRL_MMC0DAT0 == %#x\n", __FUNCTION__, __LINE__, readl( IO_PHYS_TO_VIRT(0x35004914) ) );
		printk( "[NANI] %s, %d : PAD_CTRL_MMC0DAT1 == %#x\n", __FUNCTION__, __LINE__, readl( IO_PHYS_TO_VIRT(0x35004918) ) );
		printk( "[NANI] %s, %d : PAD_CTRL_MMC0DAT2 == %#x\n", __FUNCTION__, __LINE__, readl( IO_PHYS_TO_VIRT(0x3500491C) ) );
		printk( "[NANI] %s, %d : PAD_CTRL_MMC0DAT3 == %#x\n", __FUNCTION__, __LINE__, readl( IO_PHYS_TO_VIRT(0x35004920) ) );
		printk( "[NANI] %s, %d : PAD_CTRL_MMC0DAT4 == %#x\n", __FUNCTION__, __LINE__, readl( IO_PHYS_TO_VIRT(0x35004924) ) );
		printk( "[NANI] %s, %d : PAD_CTRL_MMC0DAT5 == %#x\n", __FUNCTION__, __LINE__, readl( IO_PHYS_TO_VIRT(0x35004928) ) );
		printk( "[NANI] %s, %d : PAD_CTRL_MMC0DAT6 == %#x\n", __FUNCTION__, __LINE__, readl( IO_PHYS_TO_VIRT(0x3500492C) ) );
		printk( "[NANI] %s, %d : PAD_CTRL_MMC0DAT7 == %#x\n", __FUNCTION__, __LINE__, readl( IO_PHYS_TO_VIRT(0x35004930) ) );
	}
#endif
...
#if 0
	/***
		NANI. to check regulator initialize
	***/
	printk( "[NANI] %s, %d : %s[%s], reg_name(%s)\n", __FUNCTION__, __LINE__, mmc_hostname(dev->host->mmc), dev_name(mmc_dev(dev->host->mmc)), reg_name );
#endif
