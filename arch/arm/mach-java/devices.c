...
static struct resource hawaii_ssp3_resource[] = {
	[0] = {
...
struct platform_device hawaii_ssp3_device = {
	.name = "kona_sspi_spi",
	.id = 3,
	.resource = hawaii_ssp3_resource,
	.num_resources = ARRAY_SIZE(hawaii_ssp3_resource),
};
