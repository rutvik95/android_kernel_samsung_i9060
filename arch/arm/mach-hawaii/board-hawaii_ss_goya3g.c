...
#endif
#ifdef CONFIG_BACKLIGHT_RT8511B
#include <linux/rt8511b_pwm_bl.h>
#endif
...
static struct board_modem_detect_info hawaii_modem_detect_platform_cfg = {
	.gpen_pin_name = PN_MDMGPIO07,
	.gpen_pin_func = PF_GPIO119,
};

static struct platform_device hawaii_modem_detect_device = {
	.name = "bcm_modem_detect",
	.id = -1,
	.dev = {
		.platform_data = &hawaii_modem_detect_platform_cfg,
	},
};
...
#define CAMDRV_SS_MAIN_I2C_ADDRESS (0x40>>1)
...
struct platform_device *hawaii_modem_detect_devices[] __initdata = {
	&hawaii_modem_detect_device
};
...
#define GPIO_KEYS_SETTINGS { \
      { KEY_VOLUMEDOWN,9, 1, "VOLUMEDOWN", EV_KEY, 0, 64}, \
	{ KEY_HOME, 10, 1, "HOME", EV_KEY, 0, 64},	\
      { KEY_VOLUMEUP,11, 1, "VOLUMEUP", EV_KEY, 0, 64}, \
}
...
static struct platform_rt8511b_backlight_data bcm_rt8511b_backlight_data = {
	.max_brightness = 255,
	.dft_brightness = 160,
	.ctrl_pin = 24,
};
...
struct platform_device hawaii_backlight_device = {
	...
	.id 		= -1,
	.dev 	= {
		.platform_data  =  &bcm_rt8511b_backlight_data,
	},
};

#endif /* CONFIG_BACKLIGHT_RT8511B */
...
#ifdef CONFIG_LCD_LVDS_QUICKLOGIC_VX5B3D
static struct i2c_board_info ql_vx5b3d[] = {
	{
		I2C_BOARD_INFO("ql_vx5b3d", (0x64))
	},
};
#endif

#ifdef CONFIG_TOUCHSCREEN_BT532
#define TSP_INT_GPIO_PIN   	(73)
...
#if	defined(CONFIG_BACKLIGHT_PWM) || defined(CONFIG_BACKLIGHT_TPS61158) || defined(CONFIG_BACKLIGHT_RT8511B)
...
#ifdef CONFIG_LCD_LVDS_QUICKLOGIC_VX5B3D
	i2c_register_board_info(1, ql_vx5b3d, ARRAY_SIZE(ql_vx5b3d));
#endif

#if defined(CONFIG_TOUCHSCREEN_IST30XX)	\
		|| defined(CONFIG_TOUCHSCREEN_BT432_CS02) || defined(CONFIG_TOUCHSCREEN_BT532)
...
static void __init hawaii_add_sdio_devices(void)
{
	...
	platform_add_devices(hawaii_modem_detect_devices,
		ARRAY_SIZE(hawaii_modem_detect_devices));
}
...
MACHINE_START(HAWAII, "hawaii_ss_goya3g")
	.atag_offset = 0x100,
