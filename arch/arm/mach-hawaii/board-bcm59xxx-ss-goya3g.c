...
#if 1 //for tesst
	{.addr = PMU_REG_GPIOCTRL1, .val = 0x85, .mask = 0xFF},
	/*  enable PC3 function */
	{.addr = PMU_REG_GPIOCTRL2, .val = 0x02, .mask = 0xFF},
#else
...
/* TODO regulator */
	...
	/* SIM2LDO voltage - 3.3V */
	{.addr = PMU_REG_SIMLDO2CTRL , .val = 0x38, .mask = 0x3F},
...
static struct batt_volt_cap_map ss_goya3g_volt_cap_lut[] = {
	{4321, 100},
	{4256, 95},
	{4199, 90},
	{4146, 85},
...
static struct batt_eoc_curr_cap_map ss_goya3g_eoc_cap_lut[] = {
	 {290, 90},
	 {270, 91},
	 {250, 92},
	 {228, 93},
...
static struct batt_cutoff_cap_map ss_goya3g_cutoff_cap_lut[] = {
	{3480, 2},
	{3440, 1},
	{3400, 0},
};
...
static struct batt_esr_temp_lut ss_goya3g_esr_temp_lut[] = {
	{
		.temp = -200,
...
/* SS B100BE profile */
static struct bcmpmu_batt_property ss_goya3g_props = {
	.model = "SS B100BE",
	.min_volt = 3400,
	.max_volt = 4350,
	.full_cap = 1800 * 3600,
	.one_c_rate = 1800,
	.volt_cap_lut = ss_goya3g_volt_cap_lut,
	.volt_cap_lut_sz = ARRAY_SIZE(ss_goya3g_volt_cap_lut),
	.esr_temp_lut = ss_goya3g_esr_temp_lut,
	.esr_temp_lut_sz = ARRAY_SIZE(ss_goya3g_esr_temp_lut),
	.eoc_cap_lut = ss_goya3g_eoc_cap_lut,
	.eoc_cap_lut_sz = ARRAY_SIZE(ss_goya3g_eoc_cap_lut),
	.cutoff_cap_lut = ss_goya3g_cutoff_cap_lut,
	.cutoff_cap_lut_sz = ARRAY_SIZE(ss_goya3g_cutoff_cap_lut),
};

static struct bcmpmu_batt_cap_levels ss_goya3g_cap_levels = {
	.critical = 5,
	.low = 15,
	.normal = 75,
	.high = 95,
...
/* SS B100BE profile */
static struct bcmpmu_batt_volt_levels ss_goya3g_volt_levels = {
	.critical = 3400,
	.low = 3500,
	.normal = 3700,
	.high   = 4300,
...
static struct bcmpmu_batt_cal_data ss_goya3g_cal_data = {
	.volt_low = 3550,
	.cap_low = 5,  /* lower entering low calibration */
};

static struct bcmpmu_fg_pdata fg_pdata = {
	.batt_prop = &ss_goya3g_props,
	.cap_levels = &ss_goya3g_cap_levels,
	.volt_levels = &ss_goya3g_volt_levels,
	.cal_data = &ss_goya3g_cal_data,
	.sns_resist = 10,
	.sys_impedence = 33,
